...
const TOOLS = [
  ...
  { id:"analyser", cls:"y", title:"Website Page Analyser",
    desc:"Audit any page: indexability, on-page, Core Web Vitals, schema, E-E-A-T, AEO — plus a predicted attention heatmap for mobile and desktop.",
    pills:["Attention heatmap","Mobile + Desktop","AEO playbook"],
  ...
  { id:"email", cls:"p", title:"Email Sequence Builder",
